    ...
    <>
      ...
      <main className="flex flex-col min-h-screen bg-gray-50">
        ...
        <motion.nav 
          ...
          className="flex justify-between items-center px-6 py-3 bg-white sticky top-0 z-50 shadow-sm transition-all duration-300"
        >
          <motion.div 
          ...
          <div className="flex space-x-3">
            ...
            <Link href="/auth/login">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-indigo-600 text-white px-5 py-1.5 rounded-md text-sm flex items-center hover:bg-indigo-700 transition-colors shadow-sm"
                type="button"
        ...
        <section className="relative h-[600px] w-full overflow-hidden">
          {/* Dashboard UI background image with parallax effect */}
          <motion.div 
            ...
            <div className="container mx-auto px-8">
              <div className="max-w-full text-center">
                <motion.h1 
                  ...
                  className="text-4xl md:text-6xl font-bold text-white leading-tight mb-3 drop-shadow-md"
                >
                ...
                <motion.p 
                  ...
                  className="text-white text-base md:text-lg mb-8 max-w-3xl mx-auto"
                >
                ...
                >
                  <Link href="/dashboard/patient">
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-full sm:w-auto bg-white text-indigo-700 px-8 py-3 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors shadow-lg"
                      suppressHydrationWarning
                    >
                      Get Started
                    </motion.button>
                  ...
                  <a href="#features" suppressHydrationWarning>
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-full sm:w-auto bg-transparent text-white border-2 border-white px-8 py-3 rounded-lg text-sm font-semibold transition-colors backdrop-blur-sm"
                      suppressHydrationWarning
                    >
                      Learn More
                    </motion.button>
        ...
        <section className="px-4 py-12 md:py-20 mb-8 md:mb-16">
          <div className="max-w-6xl mx-auto">
            <motion.div 
              ...
              className="bg-white overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500"
            >
              <div className="flex flex-col md:flex-row">
                ...
                <motion.div 
                  ...
                  className="md:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-6 md:p-12 text-white flex flex-col justify-center"
                >
                  ...
                  <div>
                    <Link href="/dashboard/doctor/upload-xray">
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="w-full sm:w-auto bg-white text-indigo-600 px-8 py-3 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors shadow-lg"
                        suppressHydrationWarning
                      >
                        Try X-Ray Analysis
                      </motion.button>
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="md:w-1/2 relative h-60 md:h-auto overflow-hidden"
                >
                  <Image
                    src="/images/bg2.jpg" 
        ...
        <footer className="bg-white p-6 md:p-8 mt-auto border-t-4 border-indigo-500">
          <div className="max-w-6xl mx-auto">
