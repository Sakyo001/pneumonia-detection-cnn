...
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'ddngdvtjo',
  api_key: process.env.CLOUDINARY_API_KEY || '516343196838677',
  api_secret: process.env.CLOUDINARY_API_SECRET || 'MYC6k-Bnq6vguPo_dhVvoTaG7wM',
  secure: true,
});
